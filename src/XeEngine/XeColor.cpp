...
XeEngine::Color::Color(XeEngine::ColorARGB& o) : XeEngine::ColorARGB(o)
{
}
...
XeEngine::ColorARGB XeEngine::Color::Convert(ColorHSV& in)
{
	float hh, p, q, t, ff;
	long i;
	ColorARGB out;
...
XeEngine::ColorHSV XeEngine::Color::Convert(ColorARGB& in)
{
	ColorHSV out;
	float min, max, delta;
