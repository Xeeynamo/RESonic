...
#define PICString2Handle(u) \
	HostCString2Handle (gStuff->handleProcs, u)
	
#define PIHandle2CString(h, u, max) \
	HostHandle2CString (gStuff->handleProcs, h, u, max)

#define PIPString2Handle(u) \
	HostPString2Handle (gStuff->handleProcs, u)
	
#define PIHandle2PString(h, u) \
	HostHandle2PString (gStuff->handleProcs, h, u)
	
#define PIHandle2VersionString(h, u) \
	HostHandle2VersionString (gStuff->handleProcs, h, u)
