...
#define plugInName			"XeEngine GFX texture"
#define plugInCopyrightYear	"2012"
#define plugInDescription \
	"GFX texture format for XeEngine"
...
#define vendorName			"Xeeynamo"
#define plugInAETEComment 	"GFX texture format for XeEngine"
...
#include "GFXTerminology.h"	// Terminology for plug-in.
...
{
    {
		...
		FmtFileType { 'GFX ', '8BIM' },
		//ReadTypes { { '8B1F', '    ' } },
		FilteredTypes { { '8B1F', '    ' } },
		ReadExtensions { { 'GFX ' } },
		WriteExtensions { { 'GFX ' } },
		FilteredExtensions { { 'GFX ' } },
...
resource 'aete' (ResourceID, plugInName " dictionary", purgeable)
{
	1, 0, english, roman,									/* aete version and language specifiers */
	{
		...
		{													/* non-filter plug-in class here */
			vendorName " Xeeynamo",							/* unique class name */
